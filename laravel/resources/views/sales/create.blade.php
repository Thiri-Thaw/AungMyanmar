        ...
        <div class="col-9">
            <div class="p-2">
                ...
                <div class="row item_box" id='itemlist'>
                    ...
                    <div class="col-4 item_card  cat_id_{{$item->category_id}}" data-id="{{$item->id}}">
        ...
        <div class="d-flex justify-content-between mb-2">
            <!-- <h4 class="col-2">Invoice</h4> -->
              <div class="d-flex align-items-center col-6 row">
                 Voucher-Id: <input type="text" name="voucher_id" class="form-control form-control-sm ml-2" value="{{$voucher_id}}" readonly>
              </div>
              <div class="col-6 d-flex align-items-center">
                 Date: <input type="date" name="sale_date" class="form-control form-control-sm ml-2"  value="{{ date("Y-m-d") }}">
              </div>
        </div>
            <!-- <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                         <div>
                            <label for="">Sale Date</label>
                                <span class="float-end"><input type="text" value="{{ date('d/m/y') }}" disabled></span>
                          </div>   
                    </div>
                    
                </div>
            </div> -->
            <div class="card selected-sale-items" style="font-size:15px";>
                    ...
                    <table class="table mb-3 table-head-fixed text-center w-100" id="selected-sale-items-table">
                        ...
                        <tbody id='saleitem'>
                            <!-- <tr>
                                ...
                                <td><input type="text" name="" id="" class="form-control form-control-sm" disabled></td>
                                ...
                                <td>
                                     <div class="d-flex align-items-center">
                                        ...
                                        5 <i class="ml-1 fas fa-plus-circle"></i> 
                                    </div>
                                    <a><i class="fas fa-minus-circle text-danger mr-1"></i></a> 
                                </td>
                            </tr>  -->
                        </tbody>
                    </table>
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <select name="customer_id" id="customer_id" class="form-select form-select-sm">
                            ...
                            <option value="{{$customer->id}}" type="{{$customer->sale_type}}">{{$customer->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <!-- Remark !-->
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        <thead>
                            ...
                            <tr>
                                <th>Tax%</th>
                                <td><input type="text" name="tax" id="tax" class="form-control form-control-sm" required></td>
                            </tr>
                            <tr>
                                <th>Discount%</th>
                                <td><input type="text" name="discount" id="discount" class="form-control form-control-sm" required></td>
                            </tr>
                            <tr>
                                <th>Net Amount</th>
                                <td id="netamount"></td>
                            ...
                            <tr>
                                <th>Paid</th>
                                <td><input type="text" name="paidamount" id="paidamount" class="form-control form-control-sm" required></td>
                            </tr>
                            <tr>
                                <th>Left</th>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <input type="submit" class="btn btn-lg btn-success px-4 mr-3" value="Add">
                        <!-- <button class="btn btn-info text-dark float-end d-flex justify-content-center align-items-center" onclick="PrintReceiptContent('print')" id="print_invoice">
...
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-cookie/1.4.1/jquery.cookie.min.js" integrity="sha512-3j3VU6WC5rPQB4Ld1jnLV7Kd5xr+cq9avvhwqzbH/taCRNURoeEpoPBK9pDyeukwSxwRPJ8fDgvYXd6SkaZ2TA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> -->
    ...
    <script>
        ...
        function saleitem()
        {
            ...
            $html='';
            for($i=0;$i<$items.length;$i++){
                $html =$html+'<tr><td><input type="hidden" name="itemid[]" value="'+$items[$i].id+'">'+$items[$i].name+'</td>'+
                                '<td><input type="hidden" min="0" name="catid[]" id="" data-catid="'+$items[$i].catid+'" value="'+$items[$i].catid+'" style="width:80px">'+$items[$i].catname+'</td>'+
